...
import { Admin, deleteAdmin, fetchAdmins } from "@/features/admin/adminslice";
import AdminForm from "@/components/admin-form";

export default function AdminModule() {
  const dispatch = useAppDispatch();
  const { data: admins, pagination } = useAppSelector((state) => state.admin);
  ...
  useEffect(() => {
    dispatch(fetchAdmins({ page: page + 1, limit: rowsPerPage }));
  }, [dispatch, page, rowsPerPage, isRefresh]);
